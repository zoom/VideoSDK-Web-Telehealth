...
export default function ModalVideo({ thumb, thumbWidth, thumbHeight, thumbAlt, video, videoWidth, videoHeight }: ModalVideoProps) {
  ...
  return (
    <div>
      {/* Video thumbnail */}
      <div>
        <div className="relative mb-8 flex justify-center" data-aos="zoom-y-out" data-aos-delay="450">
          ...
          >
            <svg className="h-6 w-6 shrink-0 fill-current text-gray-400 group-hover:text-blue-600" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <Dialog initialFocus={videoRef} onClose={() => setModalOpen(false)}>
          ...
          >
            <div className="mx-auto flex h-full max-w-6xl items-center">
              <DialogPanel className="aspect-video max-h-full w-full overflow-hidden bg-black">
