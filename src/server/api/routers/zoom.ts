...
export const zoomRouter = createTRPCRouter({
  getLatestRecording: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (room) {
        const sessionId =
          room.zoomSessionsIds[room.zoomSessionsIds.length - 1];
        const getRecording = await fetch(
          `https://api.zoom.us/v2/videosdk/sessions/${sessionId}/recordings`,
          {
            headers: {
        ...
        if (getRecording.status === 3301) {
          ...
          const data =
            (await getRecording.json()) as typeof ExampleRecordingJSON;
...
const getCompletedRecordings = (
  recordings: (typeof ExampleRecordingJSON | null)[],
) => {
  ...
  recording_files: [
    {
      ...
      file_size: 3477124,
      download_url:
        "https://web.example.com/rec/download/gYV4085ivAhN0sSASa0L4KNu6lGnFvsahfIKFxIuKE5UeLrVit16OJ2tCBLSCSQLnA5dWlJ1jknPVJVu.sf0cPIDusWDMqTbO",
    ...
    },
    {
      ...
      file_size: 1104796,
      download_url:
        "https://web.example.com/rec/download/1fmg5SxfSW7UuA4cQT6282isttmNTddairEwq7uMZEJqDs7rFB-rSpQS2kBnT2zBqH5-mM3Q6nZBfQyY.djXshU4mG85q_bZ7",
  ...
  participant_audio_files: [
    {
      ...
      file_size: 1104796,
      download_url:
        "https://web.example.com/rec/download/5JNOuxxPKaYQqKmk5ZegBlUlJq6_TVapkAPlTY9uoiFWU2Xy9Ssh04_bJuT9lMrVQRVPm6nG-wX7na9a.C7pS655JRCXRE9l4",
